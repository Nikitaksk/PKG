...
MainWindow::MainWindow(QWidget * parent): QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    connect(bresenhamCircleButton, &QPushButton::clicked, this, &MainWindow::refreshImageCircle);
    ...
    connect(xCenterOfCircleSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInCircleChanged);
    ...
    connect(yCenterOfCircleSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInCircleChanged);
    ...
    connect(radiusSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInCircleChanged);
    ...
    connect(bresenhamLineButton, &QPushButton::clicked, this, &MainWindow::refreshImageLine);
    ...
    connect(yOfSecondPointSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInLinesChanged);
    connect(xOfSecondPointSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInLinesChanged);
    connect(yOfFirstPointSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInLinesChanged);
    connect(xOfFirstPointSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInLinesChanged);
    ...
    connect(x1StepSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInStepChanged);
    connect(y1StepSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInStepChanged);
    connect(x2StepSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInStepChanged);
    connect(y2StepSpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInStepChanged);

    stepLineButton = new QRadioButton(QString("Step"), this);
    connect(stepLineButton, &QPushButton::clicked, this, &MainWindow::refreshImageStepLine);
    ...
    connect(x1DDASpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInDDAChanged);
    ...
    connect(y1DDASpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInDDAChanged);
    ...
    connect(x2DDASpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInDDAChanged);
    ...
    connect(y2DDASpinBox, &QSpinBox::valueChanged, this, &MainWindow::valueInDDAChanged);

    DDALineButton = new QRadioButton(QString("DDA"), this);

    connect(DDALineButton, &QPushButton::clicked, this, &MainWindow::refreshImageDDALine);
