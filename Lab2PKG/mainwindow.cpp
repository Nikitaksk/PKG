    ...
    , ui(new Ui::MainWindow)
{
    ...
    mainTable = new QTableWidget(1, 1, this);
    mainTable->setColumnCount(5);
    mainTable -> setHorizontalHeaderLabels({"Name", "Size", "Resolution", "Color Depth", "Compression"});
    mainTable -> horizontalHeader() -> setSectionResizeMode(QHeaderView::Stretch);

    layout->addWidget(mainTable, 0, 0);
    layout->addWidget(ui->openFolderButton, 1,0);
